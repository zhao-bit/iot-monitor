...
function initRealtimeHudEffects() {
    const section = document.getElementById('realtime-detection');
    if (!section) return;

    const leftStream = document.getElementById('realtimeHexLeft');
    const rightStream = document.getElementById('realtimeHexRight');
    const frameEl = document.getElementById('realtimeHudFrame');
    const bitrateEl = document.getElementById('realtimeHudBitrate');
    const threatFillEl = document.getElementById('realtimeThreatFill');
    ...
    const targetSelector = '.detection-controls, .camera-item, .statistics-panel, .alerts-panel';
