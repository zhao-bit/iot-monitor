...
function initRecordsHudEffects() {
    const section = document.getElementById('recognition-records');
    if (!section) return;

    const leftStream = document.getElementById('recordsHexLeft');
    const rightStream = document.getElementById('recordsHexRight');
    const frameEl = document.getElementById('recordsHudFrame');
    const bitrateEl = document.getElementById('recordsHudBitrate');
    const threatFillEl = document.getElementById('recordsThreatFill');
    ...
    const targetSelector = '.records-toolbar, .record-card, .records-pagination';
